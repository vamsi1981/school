...

{
	...
	form1.action="/School/AddGraphs.do?masterData=Graphs&delete="+gtype;
	form1.submit();
}
...

{
	...
	var form1 = document.getElementById("myform1");
	form1.action="/School/AddGraphs.do?masterData=Graphs&add=true";
	form1.submit();
}
$(function ()
{
...
<html:form styleId="myform1"   action="/AddGraphs"  method="post">
...
<logic:iterate name="GraphList" id="listMsgId" >
<tr>
<td>
<bean:write name="listMsgId" property="graphTypes"/>
</td>
<td>
...
<td>Graph Type: <html:text property="graphs.graphTypes"/></td>
