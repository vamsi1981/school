...
/**
 * Home object for domain model class QuestionTable.
 * @see com.pkg.hibernate.QuestionTable
 * @author Hibernate Tools
 */
public class QuestionTableHome {

	private static final Log log = LogFactory.getLog(QuestionTableHome.class);
	...
	public void persist(QuestionTable transientInstance) {
		log.debug("persisting QuestionTable instance");
		try {
	...
	public QuestionTable merge(QuestionTable detachedInstance) {
		...
		try {
			QuestionTable result = (QuestionTable) sessionFactory
	...
	public QuestionTable findById(java.lang.String id) {
		log.debug("getting QuestionTable instance with id: " + id);
		try {
			QuestionTable instance = (QuestionTable) sessionFactory
					.getCurrentSession().get("com.pkg.hibernate.QuestionTable",
							id);
			if (instance == null) {
	...
	public List findByExample(QuestionTable instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.pkg.hibernate.QuestionTable")
