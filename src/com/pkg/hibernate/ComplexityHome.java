 ...
 * @see com.pkg.hibernate.Complexity
...
public class ComplexityHome {
	...
	public Complexity merge(Complexity detachedInstance) {
		...
		try {
			Complexity result = (Complexity) sessionFactory.getCurrentSession()
	...
	public Complexity findById(java.lang.String id) {
		log.debug("getting Complexity instance with id: " + id);
		try {
			Complexity instance = (Complexity) sessionFactory
					.getCurrentSession()
					.get("com.pkg.hibernate.Complexity", id);
			if (instance == null) {
	...
	public List findByExample(Complexity instance) {
		log.debug("finding Complexity instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.pkg.hibernate.Complexity")
