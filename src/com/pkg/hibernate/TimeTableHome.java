 ...
 * @see com.pkg.hibernate.TimeTable
	...
	public List findByExample(TimeTable instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.pkg.hibernate.TimeTable")
