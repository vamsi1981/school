...
/**
 * Home object for domain model class GeneralInfo.
 * @see com.pkg.hibernate.GeneralInfo
 * @author Hibernate Tools
 */
public class GeneralInfoHome {

	private static final Log log = LogFactory.getLog(GeneralInfoHome.class);
	...
	public void persist(GeneralInfo transientInstance) {
		log.debug("persisting GeneralInfo instance");
		try {
	...
	public GeneralInfo merge(GeneralInfo detachedInstance) {
		...
		try {
			GeneralInfo result = (GeneralInfo) sessionFactory
	...
	public GeneralInfo findById(java.lang.String id) {
		...
		try {
			GeneralInfo instance = (GeneralInfo) sessionFactory
					.getCurrentSession().get("com.pkg.hibernate.GeneralInfo",
							id);
			if (instance == null) {
	...
	public List findByExample(GeneralInfo instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.pkg.hibernate.GeneralInfo")
