...
public class ExamHome {
	...
	public Exam merge(Exam detachedInstance) {
		...
		try {
			Exam result = (Exam) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Exam findById(java.lang.String id) {
		log.debug("getting Exam instance with id: " + id);
		try {
			Exam instance = (Exam) sessionFactory.getCurrentSession().get(
					"com.pkg.hibernate.Exam", id);
			if (instance == null) {
	...
	public List findByExample(Exam instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.pkg.hibernate.Exam")
