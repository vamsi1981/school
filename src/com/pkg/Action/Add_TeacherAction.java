...
public class Add_TeacherAction extends Action 
{	
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response)throws Exception 
	{
		...
		getSession(p1,addstdnt.getPdependentDetail());
	...
	private Session getSession(Person p1,PersonDependentDetail personDependepntDetail) throws Exception
	{
		 Session s = null;
		   ...
		   try 
			   ...
			   s = DBConnection.getSession();
		         ...
		         //Query q= s.createQuery(squery);
		          ...
		          pdepid.setGuardianType(personDependepntDetail.getGuardian().getGuardianType());
